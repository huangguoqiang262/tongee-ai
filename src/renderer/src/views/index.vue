  ...
  const initialTabs = [
    {
      ...
      title: 'New Tab',
      favicon:
        'data:image/svg+xml;base64,',
      loading: false,
      progress: 100,
      canGoBack: false,
      canGoForward: false,
...
// 新建标签
const addNewTab = (url = 'https://www.baidu.com', isInternal = false) => {
  const newTab = {
    id: Date.now(),
    url: url || 'https://www.baidu.com',
    title: 'New Tab',
    favicon:
      'data:image/svg+xml;base64,',
    loading: true,
    progress: 0,
    canGoBack: false,
    canGoForward: false,
  ...
  newTab.isInternal = url.startsWith('internal://')
