    ...
    <div class="notebook-box">
            ...
            <template #default>
              <template v-if="list.length">
                <el-anchor
                    ...
                    @click="handleClick"
                >
                    <el-anchor-link class="anchor-item" v-for="(value,index) in list"
                    :key="value.id" :href="'#version'+index" :title="value.version+'主要更新'" />
                </el-anchor>
              </template>
      ...
      <div class="center-box">
        <div ref="containerRef" class="center-content">
            <div class="version-item"  v-for="(value,index) in list"
                :key="value.id" :id="'version'+index">
